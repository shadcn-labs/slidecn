...
export const metadata: Metadata = createPageMetadata({
  description:
    "Support slidecn — a template for building your own shadcn/ui registry. Sponsor tiers, stargazers, and how to contribute.",
  path: ROUTES.SPONSOR,
  title: "Sponsor",
});
      ...
      <section className="container-wrapper relative">
        <div className="container max-w-2xl flex flex-col items-center gap-4 py-16 text-center md:py-20 lg:py-24">
          ...
          <p className="text-base text-muted-foreground text-balance">
            slidecn is a collection of beautifully designed, accessible, and
            customizable presentation components for React. Every component is
            free and that&apos;s not changing.
          </p>
          <p className="text-sm text-muted-foreground text-balance">
            I&apos;m not going to paywall features or gate components behind a
            sponsorship tier. But if slidecn made your project better, or you
